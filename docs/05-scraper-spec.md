...
6. **Week assignment.** `game_week_id` = the game week whose [Sunday, Saturday] window contains `fieldwork_end` (2026-08-19; was Friday→Thursday under R7, docs/09); polls before the first game week get `null` (displayed, never scored).
7. **Status routing.**
